...
// Source: ../../auth/providers/common/provider.go
//
// Generated by this command:
//
//	mockgen -source=../../auth/providers/common/provider.go -destination=../../auth/providers/mocks/provider.go -package=mocks
//
...
func (m *MockAuthProvider) GetPrincipal(principalID string, token v3.Token) (v3.Principal, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthProvider) Logout(apiContext *types.APIContext, token *v3.Token) error {
	m.ctrl.T.Helper()
...
func (m *MockAuthProvider) LogoutAll(apiContext *types.APIContext, token *v3.Token) error {
	m.ctrl.T.Helper()
...
func (m *MockAuthProvider) SearchPrincipals(name, principalType string, myToken v3.Token) ([]v3.Principal, error) {
	m.ctrl.T.Helper()
