...
// UserCanImpersonateGroups mocks base method.
func (m *MockSubjectAccessReview) UserCanImpersonateGroups(req *http.Request, user string, groups []string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UserCanImpersonateGroups", req, user, groups)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UserCanImpersonateGroups indicates an expected call of UserCanImpersonateGroups.
func (mr *MockSubjectAccessReviewMockRecorder) UserCanImpersonateGroups(req, user, groups interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UserCanImpersonateGroups", reflect.TypeOf((*MockSubjectAccessReview)(nil).UserCanImpersonateGroups), req, user, groups)
}
