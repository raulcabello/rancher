...
const (
	...
	KeyCloakOIDCConfigFieldOrganizationJSONPath = "organizationJSONPath"
...
type KeyCloakOIDCConfig struct {
	...
	OrganizationJSONPath string            `json:"organizationJSONPath,omitempty" yaml:"organizationJSONPath,omitempty"`
