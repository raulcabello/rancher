...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClient":     schema_pkg_apis_extcattleio_v1_OIDCClient(ref),
		"github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClientList": schema_pkg_apis_extcattleio_v1_OIDCClientList(ref),
		"github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClientSpec": schema_pkg_apis_extcattleio_v1_OIDCClientSpec(ref),
...
func schema_pkg_apis_extcattleio_v1_OIDCClient(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OIDCClient represents an application that uses Rancher OIDC provider as its authentication provider.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClientSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClientSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_extcattleio_v1_OIDCClientList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OIDCClientList is a list of OIDCClient resources",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClient"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/rancher/rancher/pkg/apis/ext.cattle.io/v1.OIDCClient", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_extcattleio_v1_OIDCClientSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
