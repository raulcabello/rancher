...
func (h *Handler) reconcilePermissionsResourceRules(globalRoleBinding *v3.GlobalRoleBinding, globalRole *v3.GlobalRole, fleetWorkspaces []*v3.FleetWorkspace) error {
	...
	err := h.reconcileRulesClusterRole(globalRole, fleetWorkspacePermissionName)
	if err != nil {
		return err
	}
...
func (h *Handler) reconcileRulesClusterRole(globalRole *v3.GlobalRole, crName string) error {
...
func (h *Handler) reconcilePermissionsWorkspaceVerbs(globalRoleBinding *v3.GlobalRoleBinding, globalRole *apimgmtv3.GlobalRole, fleetWorkspaces []*apimgmtv3.FleetWorkspace) error {
	...
	err := h.reconcileVerbsClusterRole(globalRole, crName, workspacesNames)
	if err != nil {
		return err
	}
...
func (h *Handler) reconcileVerbsClusterRole(globalRole *v3.GlobalRole, crName string, resourceNames []string) error {
	rules := []v1.PolicyRule{
		{
