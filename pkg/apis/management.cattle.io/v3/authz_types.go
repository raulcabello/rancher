...
type ClusterRoleTemplateBindingStatus struct {
	...
	// SummaryLocal represents the summary of all resources. One of "Complete", "InProgress", "Terminating" or "Error".
	// +optional
	Summary string `json:"summary,omitempty"`

	// SummaryLocal represents the summary of the resources created in the local cluster. One of "Complete", "InProgress", "Terminating" or "Error".
	// +optional
	SummaryLocal string `json:"summaryLocal,omitempty"`

	// Summary represents the summary of the resources created in the downstream cluster. One of "Complete", "InProgress", "Terminating" or "Error".
	// +optional
